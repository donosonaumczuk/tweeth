...
daiTransferLessThanZeroSubscription :: EthSubscription
daiTransferLessThanZeroSubscription = EthSubscription "2.0" "eth_subscription"
    (EthParams "0x1feed340995274b5a3f497fb491dcb4e"
    (EthResult False "0x5d" "0x27" "0x2ecd88a2c0ed09d136f175f9843f78c8532de065001be03ed18bf9e4d550d553"
    "0x5d8fd3ad85a97b941f3e1f50bb54075d1b18644824a50d39039ebd78b87598fb" "0xbbe061"
    "0x6B175474E89094C44Da98b954EedeAC495271d0F" "0x00000000000000000000000000000000000000000000000000000000FA56EA00"
    ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef",
     "0x0000000000000000000000007515be43d16f871588adc135d58a9c30a71eb34f",
      "0x0000000000000000000000002ad95483ac838e2884563ad278e933fba96bc242"]))

daiTransferZeroSubscription :: EthSubscription
daiTransferZeroSubscription = EthSubscription "2.0" "eth_subscription"
    (EthParams "0x1feed340995274b5a3f497fb491dcb4e"
    (EthResult False "0x5d" "0x27" "0x2ecd88a2c0ed09d136f175f9843f78c8532de065001be03ed18bf9e4d550d553"
    "0x5d8fd3ad85a97b941f3e1f50bb54075d1b18644824a50d39039ebd78b87598fb" "0xbbe061"
...
spec = do
  describe "Eth.Events.Dai tests" $ do
    ...
    it "given dai transfer subscription when calling asTweet on transfer event then return the expected text" $ do
      expectedTweetText <- T.readFile "test/Files/Eth/Events/Dai/expectedTransferTweet.txt"
      asTweet DaiEvents.transfer daiTransferSubscription `shouldBe` expectedTweetText
    it "given less than zero dai transfer subscription when calling asTweet on transfer then return expected text" $ do
      expectedTweetText <- T.readFile "test/Files/Eth/Events/Dai/expectedTransferAmountLessThanZeroTweet.txt"
      asTweet DaiEvents.transfer daiTransferLessThanZeroSubscription `shouldBe` expectedTweetText
    it "given zero dai transfer subscription when calling asTweet on transfer then return expected text" $ do
      expectedTweetText <- T.readFile "test/Files/Eth/Events/Dai/expectedTransferAmountZeroTweet.txt"
      asTweet DaiEvents.transfer daiTransferZeroSubscription `shouldBe` expectedTweetText
